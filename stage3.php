<?php
        ...
        $view_users_query="Select * from ncacomplaints where status = 'Issue Resolved'";//select query for viewing users.
...
<head>        
        <!-- META SECTION -->
        <title>Admin Issue Resolved</title>            
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li>
                        <a href="stage2.php"><span class="fa fa-shield"></span> <span class="xn-text">Working on Issue</span></a>
                    </li>
                    <li>
                        <a href="stage3.php"><span class="fa fa-mail-forward"></span> <span class="xn-text">Contacting SP</span></a>
                    </li>
                    <li>
                        <a href="#"><span class="fa fa-check-circle-o"></span> <span class="xn-text">Issue Resolved</span></a>
                    </li>
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                  <li><a href="Admin">Home</a></li>
                   <li class="active">Issue Resolved</li> 
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title alert-success">                    
                    <h2><span class="fa fa-check-circle-o"></span> Issue Resolved</h2>
                </div>
                <!-- END PAGE TITLE -->                
