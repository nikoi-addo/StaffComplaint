...
<?php
        ...
        $view_users_query="Select * from ncacomplaints where status = 'pending'";//select query for viewing users.
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li>
                        <a href="#"><span class="fa fa-minus"></span> <span class="xn-text">Pending</span></a>
                    </li>                   
                    <li>
            ...
            <div class="page-content">
                ...
                <div class="page-title alert-danger">                    
                    <h2><span class="fa fa-minus"></span> Pending</h2>
                </div>
                <!-- END PAGE TITLE -->                
             ...
             <div id="delete<?php echo $refno; ?>" class="modal fade" role="dialog">
                 ...
                 <?php 
                            ...
                            if ($link->query($sql) === TRUE) {
                                ...
                                if ($link->query($sql) === TRUE) {
                                    $sql = "DELETE FROM ncacomplaints WHERE refno='$delete_refno' ";
                                    echo '<script>window.location.href="stage1.php"</script>';
                                } else {
